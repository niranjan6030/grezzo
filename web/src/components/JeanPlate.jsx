    ...
    >
      ...
      >
        ...
        <g>
          <path
            d={bodyPath}
            fill={flat ? "#ffffff" : `url(#w-${uid})`}
            stroke={flat ? "#14315f" : "none"}
            strokeWidth={flat ? 1.6 : 0}
          />
          <path
            d={leg(-1)}
            fill={flat ? "#ffffff" : `url(#w-${uid})`}
        ...
        {/* waistband */}
        <path
          d={`M ${CX - waistHalf} ${yWaist} L ${CX + waistHalf} ${yWaist} L ${CX + waistHalf + 3} ${yBand} L ${CX - waistHalf - 3} ${yBand} Z`}
          fill={flat ? "#ffffff" : shadow}
          stroke={flat ? "#14315f" : "none"}
          strokeWidth={flat ? 1.2 : 0}
          opacity={flat ? 1 : 0.55}
        />
        <path
          d={`M ${CX - waistHalf} ${yWaist + 4} L ${CX + waistHalf} ${yWaist + 4}`}
          {...stitch}
        />
        <path
          d={`M ${CX - waistHalf - 2} ${yBand - 4} L ${CX + waistHalf + 2} ${yBand - 4}`}
          {...stitch}
        />
        ...
        {/* fly + shank button */}
        <path
          d={`M ${CX + 8} ${yBand} C ${CX + 10} ${yBand + 30}, ${CX + 4} ${Y_HIP - 6}, ${CX} ${Y_CROTCH - 6}`}
          {...stitch}
        />
        <circle
          cx={CX - 2}
        ...
        <path
          d={`M ${CX - waistHalf + 6} ${yBand + 1} C ${CX - 34} ${yBand + 26}, ${CX - 28} ${yBand + 38}, ${CX - 23} ${yBand + 50}`}
          {...stitch}
        />
        <path
          d={`M ${CX + waistHalf - 6} ${yBand + 1} C ${CX + 34} ${yBand + 26}, ${CX + 28} ${yBand + 38}, ${CX + 23} ${yBand + 50}`}
        ...
        {/* inseam + outseam + hems */}
        <path
          d={`M ${CX - 8} ${Y_CROTCH} C ${CX - 10} ${Y_KNEE - 60}, ${CX - 9} ${Y_KNEE + 60}, ${CX - 9} ${Y_HEM - 6}`}
          {...stitch}
        />
        <path
          d={`M ${CX + 8} ${Y_CROTCH} C ${CX + 10} ${Y_KNEE - 60}, ${CX + 9} ${Y_KNEE + 60}, ${CX + 9} ${Y_HEM - 6}`}
