        ...
        return (
          <li key={step.path} className="flex flex-1 items-center gap-3 md:gap-5">
            <div className="flex items-center gap-2.5">
              <span
                className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-[0.62rem] transition-colors ${
                  done
                    ? "bg-denim-deep text-white"
                    : active
                      ? "border border-denim-deep text-denim-deep"
              ...
              <span
                className={`tracked whitespace-nowrap ${active ? "text-ink" : "text-ink-soft"}`}
              >
                {step.label}
              </span>
            </div>
