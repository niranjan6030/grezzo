...
export default function JeansBrowser() {
  ...
  const [collections, setCollections] = useState(collectionParam ? [collectionParam] : []);
    ...
    <>
      ...
      <AnimatePresence>
        {panelOpen && (
          <>
            <motion.div
              className="fixed inset-0 z-[65] bg-denim-raw/35"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <div className="flex gap-3 border-t border-line px-6 py-5">
                <button
                  ...
                  className="tracked flex-1 border border-denim-deep py-3"
                >
                  Clear
                </button>
                <button
