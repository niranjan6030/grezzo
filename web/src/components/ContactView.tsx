        ...
        <div className="px-5 py-20 md:px-10">
          ...
          {sent ? (
            ...
            <form onSubmit={submit} className="mt-8 space-y-3">
              {([["name", "NAME"], ["email", "EMAIL"], ["order", "ORDER NUMBER (OPTIONAL)"]] as const).map(([k, ph]) => (
                <input key={k} required={k !== "order"} type={k === "email" ? "email" : "text"}
              ...
              <textarea required rows={6} placeholder="MESSAGE" value={form.message}
