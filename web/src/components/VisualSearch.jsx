...
export default function VisualSearch() {
  ...
  return <AnimatePresence>{open && <LensPanel onClose={onClose} />}</AnimatePresence>;
}

function LensPanel({ onClose }) {
          ...
          <div>
            ...
            {!matches && !busy && (
              <p className="pt-6 text-sm text-ink-soft">
                Straight-on shots of the full leg work best. We read the wash, the tone and the
