...
/* Firebase is optional: without the config the storefront still works, it
...
/** Firebase error codes are not written for shoppers. */
export function friendlyAuthError(code) {
  switch (code) {
    ...
    case "auth/invalid-phone-number":
      return "Enter a phone number including the country code, like +91 98765 43210.";
