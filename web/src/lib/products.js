...
export const washCode = (w) => w.toLowerCase().replace(/\s+/g, "-");
...
const seeds = [
  {
    id: "gz-001",
    slug: "selvedge-column-high-rise",
    name: "Selvedge Column",
    pricePaise: 799000,
    fit: "Straight",
    rise: "High",
    washes: ["Raw Indigo", "Rinse", "Black Overdye"],
    sizes: STD,
    fabric: "100% cotton, unsanforised Japanese selvedge",
    weightOz: 14.5,
    stretchPct: 0,
    collection: "Atelier",
    story:
      "Woven on shuttle looms at 32 picks a minute — a tenth of modern speed. It arrives stiff, and takes about six months to become yours.",
  ...
  },
  {
    ...
    fit: "Wide Leg",
    rise: "High",
    washes: ["Mid Stone", "Light Stone", "Dark Stone"],
    sizes: STD,
    ...
    collection: "Atelier",
    story:
      "The leg opening is 26cm — deliberately wider than the hip — so the fabric falls in a single unbroken line from waist to floor.",
    tags: ["wide", "high-rise", "drapey", "statement"],
  },
  {
    id: "gz-003",
    slug: "midnight-skinny",
    name: "Midnight Skinny",
    pricePaise: 399000,
    fit: "Skinny",
    rise: "Mid",
    washes: ["Black Overdye", "Raw Indigo", "Dark Stone"],
    sizes: STD,
    ...
    collection: "Core",
    story:
      "Overdyed twice in reactive black so the indigo underneath only shows at the seams, where the thread pulls tight.",
    tags: ["skinny", "black", "stretch", "everyday"],
  },
  {
    id: "gz-004",
    slug: "bleach-cloud-baggy",
    name: "Bleach Cloud Baggy",
    pricePaise: 629000,
    fit: "Baggy",
    rise: "High",
    washes: ["Bleach", "Light Stone", "Ecru"],
    sizes: STD,
    fabric: "100% cotton",
    weightOz: 12.5,
    stretchPct: 0,
    collection: "Studio",
    story:
      "Bleached with ozone rather than chlorine — the same result using 95% less water and no discharge into the river.",
    tags: ["baggy", "bleach", "light", "oversized", "sustainable"],
  },
  {
    id: "gz-005",
    slug: "rinse-straight-classic",
    name: "Rinse Straight",
    pricePaise: 349000,
    fit: "Straight",
    rise: "Mid",
    washes: ["Rinse", "Dark Stone", "Raw Indigo"],
    sizes: STD,
    fabric: "100% cotton",
    weightOz: 12,
    stretchPct: 0,
    collection: "Core",
    story:
      "One rinse, nothing else. The wash you would get after wearing raw denim home in the rain.",
    tags: ["straight", "classic", "rinse", "everyday"],
  },
  {
    id: "gz-006",
    slug: "atelier-bootcut",
    name: "Atelier Bootcut",
    pricePaise: 579000,
    fit: "Bootcut",
    rise: "High",
    washes: ["Dark Stone", "Mid Stone", "Black Overdye"],
    sizes: STD,
    ...
    collection: "Atelier",
    story:
      "Cut narrow through the thigh and released from the knee at exactly 18 degrees — enough to clear a boot, not enough to sweep the floor.",
    tags: ["bootcut", "flare", "dark", "tailored"],
  },
  {
    id: "gz-007",
    slug: "workwear-relaxed-carpenter",
    name: "Workwear Carpenter",
    pricePaise: 519000,
    fit: "Relaxed",
    rise: "Mid",
    washes: ["Mid Stone", "Light Stone", "Dark Stone"],
    sizes: STD,
    fabric: "100% cotton duck-faced denim",
    weightOz: 13.5,
    stretchPct: 0,
    collection: "Utility",
    story:
      "Hammer loop, rule pocket, triple-needle felled seams. Built to the 1930s pattern, which was built to survive a job site.",
    tags: ["carpenter", "relaxed", "utility", "workwear", "heavyweight"],
  },
  {
    id: "gz-008",
    slug: "ecru-slim-tapered",
    name: "Ecru Slim Taper",
    pricePaise: 459000,
    fit: "Tapered",
    rise: "Mid",
    washes: ["Ecru", "Bleach", "Light Stone"],
    sizes: STD,
    fabric: "100% undyed cotton",
    weightOz: 11,
    stretchPct: 0,
    collection: "Studio",
    story:
      "Never dyed at all. What denim looks like before indigo — which is to say, what the cotton actually looks like.",
    tags: ["ecru", "undyed", "slim", "taper", "natural"],
  },
  {
    id: "gz-009",
    slug: "stonewash-loose",
    name: "Stonewash Loose",
    pricePaise: 429000,
    fit: "Regular",
    rise: "High",
    washes: ["Light Stone", "Bleach", "Mid Stone"],
    sizes: STD,
    fabric: "100% cotton",
    weightOz: 12,
    stretchPct: 0,
    collection: "Core",
    story:
      "Tumbled with pumice from Icelandic volcanic fields. Each stone lasts about forty washes before it dissolves into sand.",
    tags: ["loose", "stonewash", "vintage", "relaxed", "90s"],
  },
  {
    id: "gz-010",
    slug: "indigo-slim-stretch",
    name: "Indigo Slim Stretch",
    pricePaise: 379000,
    fit: "Slim",
    rise: "Mid",
    washes: ["Dark Stone", "Mid Stone", "Black Overdye"],
    ...
    collection: "Core",
    story:
      "Recovery yarn in the weft means the knee stops bagging by four o'clock. The single most requested fix in denim.",
    tags: ["slim", "stretch", "dark", "comfort", "everyday"],
  },
  {
    id: "gz-011",
    slug: "painter-wide-ecru",
    name: "Painter Wide",
    pricePaise: 599000,
    fit: "Wide Leg",
    rise: "High",
    ...
    collection: "Studio",
    story:
      "Double-knee, dropped crotch, side rule pocket. Modelled on the trousers house painters wore before overalls existed.",
    tags: ["painter", "wide", "ecru", "organic", "utility"],
  },
  {
    id: "gz-012",
    slug: "raw-skinny-selvedge",
    name: "Raw Skinny Selvedge",
    pricePaise: 689000,
    fit: "Skinny",
    rise: "High",
    washes: ["Raw Indigo", "Rinse", "Black Overdye"],
    sizes: STD,
    fabric: "98% cotton, 2% elastane selvedge",
    weightOz: 12.5,
    stretchPct: 8,
    collection: "Atelier",
    story:
      "Rare thing: a selvedge denim with give. Woven at half width on a vintage loom, then cut so the red line runs down the outseam.",
  ...
  },
  {
    ...
    collection: "Core",
    story:
      "Full through the thigh, closed down hard below the knee. The shape that lets a heavy boot sit under a jean without the leg stacking.",
    tags: ["taper", "loose", "roomy", "boots"],
  },
  {
    id: "gz-014",
    slug: "heavy-regular-14oz",
    name: "Heavy Regular 14oz",
    pricePaise: 559000,
    fit: "Regular",
    rise: "Mid",
    washes: ["Rinse", "Dark Stone", "Raw Indigo"],
    sizes: STD,
    fabric: "100% cotton, sanforised",
    weightOz: 14,
    stretchPct: 0,
    collection: "Utility",
    story:
      "Fourteen ounces per square yard. Heavy enough that the creases behind the knee become permanent — and become a record of how you move.",
  ...
  },
  {
    ...
    collection: "Studio",
    story:
      "The flare starts at mid-calf, not the knee, which is what separates a 70s line from a 90s one.",
    tags: ["flare", "bootcut", "bleach", "retro", "70s"],
  },
  {
    id: "gz-016",
    slug: "utility-baggy-cargo",
    name: "Utility Baggy",
    pricePaise: 649000,
    fit: "Baggy",
    rise: "Mid",
    ...
    collection: "Utility",
    story:
      "Two bellowed side pockets set on the seam rather than the front, so they stay flat when empty.",
...
export const WASH_NAMES = Object.keys(WASH_RAMP);
