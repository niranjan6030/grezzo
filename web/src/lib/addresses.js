...
export async function loadAddresses(uid) {
...
export async function createAddress(uid, fields) {
...
export async function updateAddress(uid, id, fields) {
  const db = getAdminSupabase();
...
export async function findAddress(uid, id) {
