...
function validate(body) {
  ...
  const usageLimit =
    body.usageLimit === null || body.usageLimit === undefined || body.usageLimit === ""
      ? null
  ...
  if (kind === "percent" && maxDiscountPaise === null && value > 30) {
    return {
      error:
        "A percentage over 30% needs a maximum discount, or one large order could cost you the month.",
    };
  }
