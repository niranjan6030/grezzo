...
export const metadata = {
  ...
  description:
    "How denim is woven, dyed, finished and cared for — the specification behind the garment.",
};

const TAGS = ["History", "Craft", "Fabric", "Care", "Planet", "Culture"];
      ...
      <section className="denim-weave px-5 py-24 text-white md:px-10">
        <Reveal>
          ...
          <p className="mt-6 max-w-xl text-sm leading-relaxed opacity-80">
            {DENIM_FACTS.length} things worth knowing about the only fabric we make. Checkable,
            sourced, and occasionally inconvenient for us. A different selection is featured every
            twelve hours — the full index is below.
          </p>
        </Reveal>
        ...
        <p className="mt-10 text-[0.62rem] uppercase tracking-[0.18em] opacity-50">
          Next selection{" "}
          {rotatesAt.toLocaleString("en-IN", {
            day: "numeric",
            month: "short",
            hour: "2-digit",
            minute: "2-digit",
